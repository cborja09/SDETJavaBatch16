package Class19;
    ...
    "programming languages" the value variable should be printed. Example, if we pass "Java", then
...
public class Programming {
    ...
    Programming(String randomWord){
        System.out.println("I love " + randomWord + ".");
    }
