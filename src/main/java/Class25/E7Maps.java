...
public class E7Maps {
    public static void main(String[] args) {
        ...
        System.out.println(grocery.containsKey("Banana")); //check if there's a banana
        System.out.println(grocery.containsValue(3.5)); //checks if contains 35
        System.out.println(grocery.isEmpty()); //checks if empty
